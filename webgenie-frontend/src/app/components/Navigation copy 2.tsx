    ...
    <div className="flex items-center gap-4">
      ...
      >
        <div className="relative flex items-center justify-center w-5 h-5">
          <Sun
            className="absolute w-5 h-5 transition-all duration-300 dark:opacity-0 dark:scale-75 opacity-100 scale-100"
          />
          <Moon
            className="absolute w-5 h-5 transition-all duration-300 opacity-0 scale-75 dark:opacity-100 dark:scale-100"
          />
        </div>
      </button>
